...
[doc/spec.md](doc/spec.md) が正式な機能仕様書である。実装を提案する前に必ず読むこと — ユーザーロール、画面、有給の付与/失効ルール、申請/承認フロー、概念レベルのデータモデルを定義している。仕様に組み込まれており、どの実装でも遵守すべき主要な決定事項:
